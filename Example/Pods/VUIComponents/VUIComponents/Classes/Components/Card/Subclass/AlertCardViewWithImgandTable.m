...
-(void)initializeContentView{
    ...
    if ([_alertLabel.attributedText length]>0) {
        ...
        rect = [_alertLabel.attributedText boundingRectWithSize:size options:NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading context:nil];
        
        height += rect.size.height;
        _alertLabelHeightConstraint.constant = rect.size.height;
    }


    if ([_tableViewHederLabel.attributedText length] > 0) {
       
        rect = [_tableViewHederLabel.attributedText boundingRectWithSize:size options:NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading context:nil];
