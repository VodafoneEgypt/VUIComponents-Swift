...
-(void)setPasswordValidationBlock:(ValidationBlock)passwordValidationBlock{
    ...
    confirmPasswordTextField.validationBlock = ^BOOL (NSString *text){
        ...
        return ([confirmPasswordTextField.text isEqualToString:passwordTextField.text] && passwordTextField.valid);
    };
}
...
-(void)commonInit{
    ...
    firstNameTextField.heightDidChangedBlock = ^(CGFloat height){
        ...
        firstNameViewHeoghtConstraint.constant = 45+ height;
    ...
    lastNameTextField.heightDidChangedBlock = ^(CGFloat height){
        ...
        lastNameViewHeoghtConstraint.constant = 45+ height;
    ...
    emailTextField.heightDidChangedBlock = ^(CGFloat height){
        ...
        emailViewHeoghtConstraint.constant = 45+ height;
    ...
    passwordTextField.heightDidChangedBlock = ^(CGFloat height){
        ...
        passwordViewHeoghtConstraint.constant = 45+ height;
    ...
    confirmPasswordTextField.heightDidChangedBlock = ^(CGFloat height){
        ...
        confirmViewHeoghtConstraint.constant = 45+ height;
    ...
    dateOfBirthTextField.validationBlock = ^BOOL(NSString* text){
        ...
        return ([dateOfBirthTextField.text length]>0);
    };
    
    dateOfBirthTextField.heightDidChangedBlock = ^(CGFloat height){
        
        dateOfBirthViewHeoghtConstraint.constant = 45+ height;
    ...
    mailNotificationLabel.textAlignment = ([LanguageHandler sharedInstance].currentDirection == LTR)?NSTextAlignmentLeft:NSTextAlignmentRight;
