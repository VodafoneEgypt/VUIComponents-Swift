...
-(void)initializeContentView{
    ...
    contentViewHeight += _titleLabelTopConstraint.constant + _imageTopConstraint.constant +_imageHeight.constant+_lableTopConstraint.constant/+16/*label buttom margin*/+16/*ButtonView top margin*/ +_alertLabelHeightConstraint.constant;
}
