...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Languagehandlerpod/Languagehandlerpod.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/NSAttributedString+CCLFormat/NSAttributedString_CCLFormat.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/VUIComponents/VUIComponents.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VUIComponents-Swift/VUIComponents_Swift.framework"
